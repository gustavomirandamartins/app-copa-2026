...
import { KnockoutBracket } from '@/components/jogos/KnockoutBracket';
...
const KNOCKOUT_STAGES: MatchStage[] = ['round-of-32', 'round-of-16', 'quarter-final', 'semi-final', 'final', 'third-place'];
...
export function JogosClient({ matches }: { matches: Match[] }) {
  ...
  const isKnockoutStage = activeStage !== 'all' && activeStage !== 'group' && KNOCKOUT_STAGES.includes(activeStage as MatchStage);
  ...
  return (
    <div className="container">
      ...
      {isKnockoutStage ? (
        <KnockoutBracket matches={filteredMatches} stage={activeStage as 'round-of-32' | 'round-of-16' | 'quarter-final' | 'semi-final' | 'final' | 'third-place'} />
      ) : (
